...
export const metadata: Metadata = {
  ...
  title: "UX/UI дизайнер | Создание и разработка сайтов в Сургуте",
  description:
    "UX/UI-дизайнер в Сургуте. Создаю современные сайты и интерфейсы: дизайн, адаптивная верстка и разработка от идеи до запуска",
